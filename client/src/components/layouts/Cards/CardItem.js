...
const CardItem = ({ card }) => {
  ...
  const { _id, bankName, cardName, cardNumber, expirationDate, type } = card;
    ...
    <div className="card bg-light">
      <h3 className="test-primary text-left">
        ...
        <span
          ...
          className={
            "badge " +
            (type === "Master card" ? "badge-success" : "badge-primary")
          }
        >
      ...
      <button className="btn btn-dark btn-sm" onClick={() => setCurrent(card)}>
        Edit
      </button>
